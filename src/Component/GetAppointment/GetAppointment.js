                                        ...
                                        <tr key={i}>
                                            ...
                                            <td>
                                                ...
                                                <span>  <button className='btn-edit'>
                                                        <Link to={"/createPatient/"+item.id} className="greenlink"> <RiEdit2Line /> Edit  </Link> </button> </span>

                                                    <span>  <button className='btn-edit'>
                                                        <Link to={"/prescription/" + item.id} className="greenlink"> <RiEdit2Line /> Accept  </Link> </button> </span>
